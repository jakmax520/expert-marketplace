...
| 工具 | 用途 |
|------|------|
| `sheet.get_sheets_info` | 获取工作表列表 |

#### 数据操作
| 工具 | 用途 |
|------|------|
| `sheet.get_range_data` | 获取选区数据 |
| `sheet.update_range_data` | 批量更新选区数据 |

#### 条件格式
| 工具 | 用途 |
|------|------|
| `sheet.get_conditional_format_rules` | 获取条件格式规则 |
| `sheet.create_conditional_format_rules` | 创建条件格式规则 |
| `sheet.update_conditional_format_rules` | 更新条件格式规则 |
| `sheet.delete_conditional_format_rules` | 删除条件格式规则 |

#### 数据校验
| 工具 | 用途 |
|------|------|
| `sheet.get_data_validations` | 获取数据校验规则 |
| `sheet.create_data_validations` | 创建数据校验规则 |
| `sheet.update_data_validations` | 更新数据校验规则 |
| `sheet.delete_data_validations` | 删除数据校验规则 |

#### 区域权限
| 工具 | 用途 |
|------|------|
| `sheet.list_protection_ranges` | 获取区域权限列表 |
| `sheet.create_protection_ranges` | 创建区域权限 |
| `sheet.update_protection_ranges` | 批量更新区域权限 |
| `sheet.delete_protection_ranges` | 批量删除区域权限 |
